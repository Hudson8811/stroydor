...
!function (D, u) {
    ...
    function A(D) {
        ...
        for (u = 0; u < F; u++) (e = t[u])._isSplit ? A(e) : (u && e.previousSibling && 3 === e.previousSibling.nodeType ? e.previousSibling.nodeValue += 3 === e.nodeType ? e.nodeValue : e.firstChild.nodeValue : 3 !== e.nodeType && D.insertBefore(e.firstChild, e), D.removeChild(e))
    }
    ...
    function C(D, u, e, F, C, i, n) {
        var E, s, r, o, l, d, a, h, f, c, g, m, v = p(D), S = B("paddingLeft", v), b = -999,
            w = B("borderBottomWidth", v) + B("borderTopWidth", v),
            _ = B("borderLeftWidth", v) + B("borderRightWidth", v), T = B("paddingTop", v) + B("paddingBottom", v),
        ...
        if (k) {
            ...
            for (h = " " === j && (!G || !P && !q), E = 0; E < k.length; E++) {
                for (a = k[E], (c = Q.createElement(M)).style.cssText = "display:block;text-align:" + O + ";position:" + (G ? "absolute;" : "relative;"), I && (c.className = I + (J ? E + 1 : "")), V.push(c), r = a.length, s = 0; s < r; s++) "BR" !== a[s].nodeName && (o = a[s], c.appendChild(o), h && o._wordEnd && c.appendChild(Q.createTextNode(" ")), G && (0 === s && (c.style.top = o._y + "px", c.style.left = S + m + "px"), o.style.top = "0px", m && (o.style.left = o._x - m + "px")));
                0 === r ? c.innerHTML = "&nbsp;" : P || q || (A(c), x(c, String.fromCharCode(160), " ")), G && (c.style.width = g, c.style.height = o._h + "px"), D.appendChild(c)
            }
            D.style.cssText = f
        }
        G && (n > D.clientHeight && (D.style.height = n - T + "px", D.clientHeight < n && (D.style.height = n + w + "px")), i > D.clientWidth && (D.style.width = i - N + "px", D.clientWidth < i && (D.style.width = i + _ + "px"))), y(e, W), P && y(F, H), y(C, V)
    }
    ...
    function D(D, e, F, C) {
        var i, n, E, s, r, o, l, d, p = e.tag ? e.tag : e.span ? "span" : "div",
            ...
            m = Q.createElement("div"), y = D.parentNode;
        for (y.insertBefore(m, D), m.textContent = D.nodeValue, y.removeChild(D), l = -1 !== (i = function getText(D) {
            ...
            return e
        }(D = m)).indexOf("<"), !1 !== e.reduceWhiteSpace && (i = i.replace(b, " ").replace(S, "")), l && (i = i.split("<").join("{{LT}}")), r = i.length, n = (" " === i.charAt(0) ? f : "") + F(), E = 0; E < r; E++) if (o = i.charAt(E), g && (d = g(i.substr(E), e.specialChars))) o = i.substr(E, d || 1), n += a && " " !== o ? C() + o + "</" + p + ">" : o, E += d - 1; else if (o === B && i.charAt(E - 1) !== B && E) {
    ...
    function E(u, e, F, C) {
        var i, n, r = s(u.childNodes), o = r.length, l = t(e);
        if (3 !== u.nodeType || 1 < o) {
    ...
    var Q, F, i, n, S = /(?:\r|\n|\t\t)/g, b = /(?:\s\s+)/g, r = "SplitText",
        o = m(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), l = function (D) {
            return u
